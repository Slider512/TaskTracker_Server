        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffortHours = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dependencies_Tasks_FromTaskId",
                        column: x => x.FromTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Dependencies_Tasks_ToTaskId",
                        column: x => x.ToTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dependencies_FromTaskId",
                table: "Dependencies",
                column: "FromTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_Dependencies_ToTaskId",
                table: "Dependencies",
                column: "ToTaskId");
